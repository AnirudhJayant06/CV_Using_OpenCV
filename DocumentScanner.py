...
def reorder(points):
    ...
    #This calculates the sum of each points and store it in an array. Here '1' indicate the axis
    sum = points.sum(1)
    ...
    '''
    # Calculating differene of the points
...
def getWarp(img, biggest):
    ...
    # Creating Perspective Transform Filter using pt1 & pt2
    ...
    cropped_img = output_img[20:output_img.shape[0] - 20, 20:output_img.shape[1] - 20]
